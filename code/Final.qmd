...
ggplot(data = nests_clean, # set data to nest_clean
       mapping = aes(x = height_cm, # x-axis height
                     ...
                     color = as.factor(scientific_name))) + # color based on ant name
...
***Figure 2. Probability of Cooking Dinner differs based on hours worked.*** The figure depicts a the individual data points, predicted probability based on hours worked, and the confidence interval associated with the probability that I cook at home depending on how much I work, with 1 indicating I cook at home and 0 indicating I eat out. Small blue open circles represent individual observations of whether I cooked at home or not in relation to the amount I worked that day. The bold red line represents the model prediction of cooking at home given time worked (hours). Finally the red ribbon represents the 95% confidence interval. Data collected by Stephen Bond from 2026-04-20 to 2026-05-30.
