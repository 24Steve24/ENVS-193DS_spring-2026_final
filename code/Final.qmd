...
### Part 1. 
We found that American Avocets do not use microhabitats in a random fashion, but rather with respect to distance to water edge. In this sense, distance to a water edge predictor the likelihood American Avocet use a microhabitat.
